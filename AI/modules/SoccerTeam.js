...
class SoccerTeam {
    ...
    CreatePlayers() {
        ...
        for( let it = 0, size = this.m_Players.length; it < size; it++ ){
           ...
           AllPlayers.push( this.m_Players[ it ] );
        };
...
const GoalKeeper = require( '../modules/GoalKeeper.js' );
const FieldPlayer = require( '../modules/FieldPlayer.js' );
const Vector2D = require( '../modules/Vector2D.js' );
const StateMachine = require( '../modules/StateMachine.js' );
...
const SupportSpotCalculator = require( '../modules/SupportSpotCalculator.js' );
